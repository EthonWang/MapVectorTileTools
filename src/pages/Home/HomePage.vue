...
<template>
  <div class="homepage">
    <el-container>
      <el-header class="flex-start-center" height="30px" style="background-color: #dcdfe6; ">
        <div style="width: 280px;">
          <span>Shp预览与瓦片生产工具</span>
        </div>
        <div>
          <el-row style="height: 10%;">
            <el-button type="primary" round size="mini" @click="createCacheDialogShow = true">新建缓存</el-button>
            <el-dialog class="create-cache-dialog" title="新建缓存任务" :visible.sync="createCacheDialogShow" width="90%">
              <el-form :inline="true" label-position="right" label-width="60px" :model="createCacheForm"
                style="width:100%">
                <el-form-item label="名称">
                  <el-input v-model="createCacheForm.name" placeholder="缓存任务名称"></el-input>
                </el-form-item>
                <el-form-item label="描述">
                  <el-input v-model="createCacheForm.description" placeholder="描述"></el-input>
                </el-form-item>
              </el-form>
              ...
              <div class="flex-space-center">
                <div style="width: 40%;">
                  <el-row class="flex-center-center" style="height: 20%;">
                    <el-select v-model="pgSourceSelect" placeholder="选择pg源" style="width: 85%;"
                      @change="handlePgSelect">
                      <el-option v-for="item in pgSourceList" :key="item" :label="item" :value="item">
                      </el-option>
                    </el-select>

                    <el-tooltip content="添加pg源" placement="bottom" effect="light">
                      <el-button type="primary" icon="el-icon-circle-plus-outline" circle
                        @click="addPgDialogShowInside = true"></el-button>
                    </el-tooltip>
                  </el-row>
                  <el-table ref="shpSelectTable" :data="pgShpList" style="width: 100%; height: 40%" height="34vh"
                    @selection-change="handleShpSelectChange">
                    <el-table-column type="index" width="30">
                    </el-table-column>
                    <el-table-column prop="shpName" label="名称" >
                    </el-table-column>
                    <el-table-column prop="shpType" label="类型" >
                    </el-table-column>
                ...
                <div style="width:60%">
                  <el-table :data="cacheLayers" style="width: 100%" height="40vh">
                    <el-table-column prop="shpName" label="名称" min-width="50" show-overflow-tooltip>
                    </el-table-column>
                    <el-table-column label="属性" min-width="80">
                      <template slot-scope="scope">
                        <el-input size="mini" v-model="scope.row.field">
                        </el-input>
                      </template>
                    </el-table-column>
                    <el-table-column label="min" min-width="45">
                      <template slot-scope="scope">
                        <el-input size="mini" v-model="scope.row.minzoom">
                        </el-input>
                      </template>
                    </el-table-column>
                    <el-table-column label="max" min-width="45">
                      <template slot-scope="scope">
                        <el-input size="mini" v-model="scope.row.maxzoom">
                        </el-input>
                      </template>
                    </el-table-column>
                    <el-table-column label="bounds" min-width="100" show-overflow-tooltip>
                      <template slot-scope="scope">
                        <el-input size="mini" v-model="scope.row.bounds">
                        </el-input>
                      </template>
                    </el-table-column>
                  </el-table>
              ...
              <span slot="footer" class="dialog-footer" >
                <el-button @click="createCacheDialogShow = false">取 消</el-button>
                <el-button type="primary" @click="submitCreateCache">确 定</el-button>
              </span>
            </el-dialog>

            <!-- 里面 -->
            <el-dialog title="-填写信息添加PG源" :visible.sync="addPgDialogShowInside" width="35%">
              <el-form label-position="right" label-width="60px" :model="addPgForm">
                <el-form-item label="ip">
                  <el-input v-model="addPgForm.ip" placeholder="必选"></el-input>
                </el-form-item>
                <el-form-item label="port">
                  <el-input v-model="addPgForm.port" placeholder="必选"></el-input>
                </el-form-item>
                <el-form-item label="pg名称">
                  <el-input v-model="addPgForm.pgName" placeholder="必选"></el-input>
                </el-form-item>
                <el-form-item label="用户名">
                  <el-input v-model="addPgForm.userName" placeholder="必选"></el-input>
                </el-form-item>
                <el-form-item label="密码">
                  <el-input v-model="addPgForm.password" placeholder="必选"></el-input>
                </el-form-item>
              </el-form>
              <span slot="footer" class="dialog-footer" >
                <el-button @click="addPgDialogShowInside = false">取 消</el-button>
                <el-button type="primary" @click="submitAddPg">确 定</el-button>
              </span>
            </el-dialog>

            <el-button type="warning" round size="mini">任务列表</el-button>
      ...
      <el-container>
        <el-aside style="background-color: rgb(238, 241, 246); height: calc(100vh - 30px);">
          <div style="height: 40%;">
            <el-row class="flex-center-center" style="height: 20%;">
              <el-select v-model="pgSourceSelect" placeholder="请选择" style="width: 85%;" @change="handlePgSelect">
                <el-option v-for="item in pgSourceList" :key="item" :label="item" :value="item">
                </el-option>
              </el-select>
              ...
              <el-dialog title="填写信息添加PG源" :visible.sync="addPgDialogShow" width="35%">
                <el-form label-position="right" label-width="60px" :model="addPgForm">
                  <el-form-item label="ip">
                    <el-input v-model="addPgForm.ip" placeholder="必选"></el-input>
                  </el-form-item>
                ...
                <span slot="footer" class="dialog-footer">
                  <el-button @click="addPgDialogShow = false">取 消</el-button>
                  <el-button type="primary" @click="submitAddPg">确 定</el-button>
                </span>
              </el-dialog>
            </el-row>

            <el-table :data="pgShpList" style="width: 100%;" height="80%" >
              <el-table-column prop="shpName" label="名称" >
              </el-table-column>
              <el-table-column prop="shpType" label="类型" >
              ...
              <el-table-column prop="name" label="操作" >
                <template slot-scope="scope">
                  <el-button type="success" plain size="mini" @click="scope">添加</el-button>
                </template>
              </el-table-column>
            </el-table>
          </div>
